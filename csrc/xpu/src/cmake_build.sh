...
export PATH=/opt/output/work_dir/cmake-3.26.0-linux-x86_64/bin:$PATH
rm -rf build
...
export XDNN_PATH=/opt/output/work_dir/xpu_libs/xhpc/xdnn
export XRE_PATH=/opt/output/work_dir/xpu_libs/xre
export CLANG_PATH=/opt/output/work_dir/xpu_libs/xdnn_plugin/xtdk_output/xtdk-llvm15-ubuntu2004_x86_64
cd plugin
bash ./cmake_build.sh
cd -
...
export XPU_LIB=/opt/output/work_dir/xpu_libs
