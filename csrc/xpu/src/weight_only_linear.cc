...
std::vector<paddle::Tensor> WeightOnlyLinearKernel(
  ...
  // paddle::Tensor weight_scale_fp32 = paddle::full(
  //           weight_scale->shape(),
  //           -1,
  ...
  baidu::xpu::xblas::FcFusionTensor<const int8_t> tensor_w{
      weight.data<int8_t>(), nullptr, n, k, k, true};
  ...
  baidu::xpu::xblas::FcFusionTensor<XPUType> tensor_y{
      input_y, nullptr, m, n, n, false};
  baidu::xpu::xblas::FcFusionDesc<XPUType, float, float> desc{1.0f, // int8_wo_t
                                                                     0.0f};
  baidu::xpu::xblas::FcFusionEpilogue<float, float> epilogue{
      api::Activation_t::LINEAR,
      bias ? bias_fp32.data<float>() : nullptr,
      nullptr,
      weight_scale.data<float>(),  // weight_scale_fp32.data<float>(), 
      0,
      1,
      nullptr};
