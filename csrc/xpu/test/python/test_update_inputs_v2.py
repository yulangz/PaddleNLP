...
class GetUpdateInputsTest(unittest.TestCase):
    def test_update_inputs(self):
        ...
        tensor8 = paddle.to_tensor([[2160, 5726, 25, 100001, 100001, 100001]], dtype='int64', place=paddle.XPUPlace(0), stop_gradient=True)
        ...
        arg = [
            ...
            tensor6, tensor7, tensor8, tensor9, tensor10, 
